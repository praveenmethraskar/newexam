  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const flattenedFranchiseData = Array.isArray(franchiseData[0])
          ? franchiseData[0]
          : franchiseData

        if (
          !Array.isArray(flattenedFranchiseData) ||
          flattenedFranchiseData.length === 0
        ) {
          throw new Error("No associated franchises found for the user.")
        }

        if (
          !Array.isArray(durationData.options) ||
          durationData.options.length === 0
        ) {
    ...
    <div style={styles.container}>
      ...
      <form onSubmit={handleCreateExamData} style={styles.form}>
        <div style={styles.formGroup}>
          <label htmlFor="franchiseId" style={styles.label}>
            Select Franchise
          </label>
          <select
            name="franchiseId"
        ...
        <div style={styles.formGroup}>
          <label htmlFor="userFullName" style={styles.label}>
            Full Name
          </label>
          <input
            type="text"
        ...
        <div style={styles.formGroup}>
          <label htmlFor="examName" style={styles.label}>
            Exam Name
          </label>
          <select
            name="examName"
        ...
        <div style={styles.formGroup}>
          <label htmlFor="durationInMinutes" style={styles.label}>
            Duration (Minutes)
          </label>
          <select
